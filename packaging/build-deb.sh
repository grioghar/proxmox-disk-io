...
install -D -m 0755 "$SRC_DIR/bin/pve-disk-io-temp" "$STAGE/usr/sbin/pve-disk-io-temp"
...
install -D -m 0644 "$SRC_DIR/systemd/pve-disk-io-temp.service" \
    "$STAGE/lib/systemd/system/pve-disk-io-temp.service"
install -D -m 0644 "$SRC_DIR/systemd/pve-disk-io-temp.timer" \
    "$STAGE/lib/systemd/system/pve-disk-io-temp.timer"
